        ...
        <MDBRow className="text-center text-md-left mt-3 pb-3">
          <MDBCol md="3" lg="3" xl="4" className="mx-auto mt-3">
            <h6 className="text-uppercase mb-4 font-weight-bold">
              ...
              <strong>NextBook</strong>
            </h6>
            <p>
            Your personalized literary guide powered by machine learning. Discover your next favorite read with tailored recommendations based on your preferences. Let NextBook's intelligent algorithms navigate through vast literary landscapes to find the perfect book just for you.
            </p>
          </MDBCol>
          ...
          <MDBCol md="2" lg="2" xl="2" className="mx-auto mt-3">
            ...
            <p>
              <a href="#">Library Recommendation System</a>
            </p>
            <p>
